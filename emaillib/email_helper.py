...
def send_email(file, changeset, name, emailID, report):
	...
	message = 'Hi All,<br><br>&nbsp;&nbsp;&nbsp;&nbsp;PFA for Jenkins regression suites Test plan file <b>'\
					...
					+ str(changeset)+'</b>. <br> The total number of jobs files failed is  '+ str(len(report))+'</br><br> Name of the committer '\
					+ str(name)+'</br><br> Email ID of the committer '+ str(emailID)+'</br><br> List of files not having valid header </br>'
